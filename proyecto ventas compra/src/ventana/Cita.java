...
String Nom = txtNom.getText();
       ...
       a.loadFile(new File("Comprador111.txt"));
       
       for (int i = 0; i <a.Comprador111list.size(); i++) {
            if(a.Comprador111list.get(i).getNombre().equals(Nom)){
                txtConf.setText(a.Comprador111list.get(i).getConfirmacion());
                txtFecha.setText(a.Comprador111list.get(i).getFecha());
            }
       }           // TODO add your handling code here:
...
String Nom = txtNom.getText();
       ...
       for (int i = 0; i <a.Comprador111list.size(); i++) {
            if(a.Comprador111list.get(i).getNombre().equals(Nom)){
             Comprador111 com = new Comprador111(txtNom.getText(),txtConf.getText(),txtFecha.getText());
             a.Comprador111list.remove(i);
