 ...
 * @author ecascavita17
 */
public class RegAlquiler extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        alquiler.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NOMBRE Y APELLIDOS", "LOCALIDAD ", "PRESUPUESTO", "DESCRPCION PERSONAL"
            }
        ));
 ...
 JFileChooser dlg = new JFileChooser();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        txtDescripcion.setText("");
         ...
         public void mostrar ()
{
    String matriz[][]= new String[a.Comprador11list.size()][4];
    for(int i =0 ; i <a.Comprador11list.size(); i++)
    {
        matriz[i][0]=a.Comprador11list.get(i).getNombre();
        matriz[i][1]=a.Comprador11list.get(i).getLocalidad();
        matriz[i][2]=String.valueOf(a.Comprador11list.get(i).getPresu()); 
        matriz[i][3]=a.Comprador11list.get(i).getMatrimonial();
    }
    ...
    alquiler.setModel(new javax.swing.table.DefaultTableModel(
          ...
          matriz,
            new String [] {
                "NOMBRE Y APELLIDOS", "LOCALIDAD ", "PRESUPUESTO","DESCRIPCION PERSONAL"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegAlquiler().setVisible(true);
            }
        });
    }
