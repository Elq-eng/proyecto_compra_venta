 ...
 * @author ecascavita17
 */
public class RegComprador extends javax.swing.JFrame {
 ...
 JFileChooser dlg = new JFileChooser();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        txtDescripcion.setText("");
         ...
         public void mostrar ()
{
    String matriz[][]= new String[a.Comprador22list.size()][4];
    for(int i =0 ; i <a.Comprador22list.size(); i++)
    {
        matriz[i][0]=a.Comprador22list.get(i).getNombre();
        matriz[i][1]=a.Comprador22list.get(i).getLocalidad();
        matriz[i][2]=String.valueOf(a.Comprador22list.get(i).getPresu()); 
        matriz[i][3]=a.Comprador22list.get(i).getRelacion();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegComprador().setVisible(true);
            }
        });
    }
