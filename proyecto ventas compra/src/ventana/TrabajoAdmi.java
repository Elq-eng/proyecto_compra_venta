 ...
 * @author ELQUIN
 */
public class TrabajoAdmi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(txtNoti, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel4)
                .addGap(18, 18, 18)
...
// TODO add your handling code here:
    ...
    private void ENVIARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ENVIARActionPerformed
       ...
       for (int i = 0; i <a.Comprador11list.size(); i++) {
            if(a.Comprador11list.get(i).getNombre().equals(Nom)){
             Comprador11 com = new Comprador11(txtBuscar.getText(),txtNoti.getText());
             a.Comprador11list.remove(i);
             a.addComprador(com);
            }
...
this.setVisible(false);// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TrabajoAdmi().setVisible(true);
            }
        });
    }
