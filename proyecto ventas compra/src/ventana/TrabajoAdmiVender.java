 ...
 * @author ELQUIN
 */
public class TrabajoAdmiVender extends javax.swing.JFrame {

    /**
     * Creates new form TrabajoAdmi
     */
    public TrabajoAdmiVender() {
        initComponents();
...
String Nom = txtBuscar.getText();
       ...
       for (int i = 0; i <a.Vendedorpplist.size(); i++) {
            if(a.Vendedorpplist.get(i).getNombre().equals(Nom)){
             Vendedorpp com = new Vendedorpp(txtBuscar.getText(),txtNoti.getText());
             a.Vendedorpplist.remove(i);
             a.addVendedor(com);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TrabajoAdmiVender().setVisible(true);
            }
        });
    }
